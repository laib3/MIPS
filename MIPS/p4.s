;Write an assembly program that implements the following piece of code: 
;for (i = 0; i < 30; i++){	
;	v5[i] = (v1[i] - v2[i]) * v3[i];
;	v6[i] = v5[i] * v3[i]
;	v7[i] =(v6[i] + v4[i]) * v2[i]:
;}
;where v1, v2, v4 are randomly generated arrays and v5, v6, v7 are initially 
;empty arrays allocated in memory
