;unrolling: unroll 3 times the body of the for loop in p4v3.s 
;so that there are 3 copies of the body; 
;after the unrolling, reschedule again the instructions to further 
